# How to Run with MBCC and Covid app

```GENESIS_URL=http://test.bcovrin.vonx.io/genesis docker/manage start```

It needs to access the ledger to retrieve the hash of the tail file to compare with the uploaded tail file.

Then, it will store the uploaded tail file to the tail file server. 
